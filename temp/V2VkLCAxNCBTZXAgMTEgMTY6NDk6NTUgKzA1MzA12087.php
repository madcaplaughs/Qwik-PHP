...
$auth1 = 'div{{for ($i=0; $i < 10; %i++){ echo "i am now $i"; } if ($true) { echo $i; echo $ohmywife; } }}.a456#box4(style:$style){{for ($i=0; $i < 10; %i++){ echo "i am now $i"; } if ($true) { echo $i; echo $ohmywife; } }}';
